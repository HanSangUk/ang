...
<body>
	<form action="Deleteprocess" method="post" name="updateform">
		아이디 : <input name="mid" id="mid" value="${Delete.mid}" readonly><br>
		비밀번호확인 : <input type="password" name="mpassword" id="mpassword"><br>
	</form>
	<button onclick="DeleteProcess()">회원탈퇴</button>
	<br>
</body>
</html>
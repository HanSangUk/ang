...
<body>
	<form action="join" method="post">
		...
		성별 : <input type="radio" name="mgender" id="mgender" value="남자">남자
			<input type="radio" name="mgender" id="mgender" value="여자">여자<br>	
		전화번호 : <input type="text" name="mphone" id="mphone"><br>
		주소 : <div name="maddress">
